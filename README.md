# RIMS BBA '24 — 5th Semester

Unofficial batch resource for the RIMS BBA batch of 2024, 5th Semester (Sections A & B).

- **Timetable** (`index.html`) — weekly grid with Section (A/B) and Specialisation (Finance/Marketing/HR) toggles.
